...
<body>
    ...
    <script>
        ...
        $('#formSalida').submit(function (e) {
            ...
            $.ajax({
                ...
                data: { registroId: registroId, horaIngreso:horaIngreso, horaSalida: horaSalida, costoTotal: costoTotal }, // Pasar el costo como parámetro
    ...
    $.ajax({
        ...
        data: { id: id, nuevoCosto: nuevoCosto },
        success: function (response) {
            alert(response);
