...
<li class="nav-item">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="container mt-5">
                    ...
                    <div class="row">
                        <div class="col-md-8 ">
                            <h2 class="text-center">Crear Placa</h2>
                            <form method="POST" action="../controllers/guardar_placa.php">
                                ...
                                <button type="submit" class="btn btn-primary">Registrar Placa</button>
                            </form>
